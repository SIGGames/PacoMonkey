...
namespace Rebinding_UI {
    ...
    public class RebindActionUIEditor : UnityEditor.Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            using (new EditorGUI.IndentLevelScope()) {
                EditorGUILayout.PropertyField(_actionOverrideProperty);
                if (_rebindActionUI.overrideActionLabel) {
                    EditorGUILayout.PropertyField(_actionOverrideStringProperty);
                }
            }
